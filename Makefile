...
install:
	...
	install -Dm644 completions/_atomic-gc \
		$(DESTDIR)$(PREFIX)/share/zsh/site-functions/_atomic-gc
	install -Dm644 completions/_atomic-rebuild-uki \
		$(DESTDIR)$(PREFIX)/share/zsh/site-functions/_atomic-rebuild-uki
	install -Dm644 completions/atomic-gc.bash \
		$(DESTDIR)$(PREFIX)/share/bash-completion/completions/atomic-gc
	install -Dm644 completions/atomic-rebuild-uki.bash \
		$(DESTDIR)$(PREFIX)/share/bash-completion/completions/atomic-rebuild-uki
...
uninstall:
	...
	rm -f $(DESTDIR)$(PREFIX)/share/zsh/site-functions/_atomic-gc
	rm -f $(DESTDIR)$(PREFIX)/share/zsh/site-functions/_atomic-rebuild-uki
	rm -f $(DESTDIR)$(PREFIX)/share/bash-completion/completions/atomic-gc
	rm -f $(DESTDIR)$(PREFIX)/share/bash-completion/completions/atomic-rebuild-uki
